...
def enhance_img(save_img_path):
    ...
    plt.imsave(save_img_path, predicted_image,cmap='gray')



for i, img in enumerate(os.listdir(deg_image_dir)):
    if img.lower().endswith(('.png', '.jpg', '.jpeg')):
        deg_image_path = os.path.join(deg_image_dir, img)
        ...
        enhance_img(save_img_path)
        print(f"Enhanced image saved to: {save_img_path}")