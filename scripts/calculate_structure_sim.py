...
with open("/home/dhruvi/Simform/learning_project/qwen2.5vl-ocr-finetune/OCR_inference_data/processed_finetuned_qwen_inference_results.json", "r", encoding="utf-8") as f:
    results = json.load(f)
